...
class ModelReportProduct extends Model {
    ...
    public function getCountPurchased($data) {
    ...
    public function getTotalPurchased($data) {
        $sql = "SELECT SUM(op.total) AS total FROM `" . DB_PREFIX . "order_product` op LEFT JOIN `" . DB_PREFIX . "order` o ON (op.order_id = o.order_id)";
