...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/category.png" alt="" /> <?php echo $heading_title . $heading_title_name; ?></h1>
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
        <div id="tabs" class="htabs">
            <a href="#tab-general"><?php echo $tab_general; ?>
            </a><a href="#tab-data"><?php echo $tab_data; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-product">
          <table class="list">
            <thead>
              <tr>
                <td class="left"><?php echo $column_product_image; ?></td>
                <td class="left"><?php echo $column_product_name; ?></td>
                <td class="left"><?php echo $column_product_model; ?></td>
                <td class="right"><?php echo $column_product_price; ?></td>
                <td class="right"><?php echo $column_product_quantity; ?></td>
            ...
            <tbody>
              ...
              <thead>
              <tr>
                <td class="right" colspan="5"><?php echo $text_product_price; ?></td>
                <td class="right"><?php echo $product_total?></td>
              </tr>
              </thead>
