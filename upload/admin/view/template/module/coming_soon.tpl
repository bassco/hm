      ...
      <table id="module" class="list">
        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><input type="text" name="<?php echo $classname; ?>_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="1" /></td>
            <td class="left"><input type="text" name="<?php echo $classname; ?>_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" size="3" />
              <input type="text" name="<?php echo $classname; ?>_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" size="3" />
...
function addModule() {
    ...
    <?php } ?>
    html += '    </td>';
    html += '    <td class="left"><input type="text" name="<?php echo $classname; ?>_module[' + module_row + '][limit]" value="5" size="1" /></td>';
	html += '    <td class="left"><input type="text" name="<?php echo $classname; ?>_module[' + module_row + '][image_width]" value="60" size="3" /> <input type="text" name="<?php echo $classname; ?>_module[' + module_row + '][image_height]" value="60" size="3" /></td>';	
