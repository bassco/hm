...
<div id="header">
  ...
  <div id="menu">
        ...
        <ul>
          <li><a class="parent"><?php echo $text_sale; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $report_sale_summary; ?>"><?php echo $text_report_sale_summary; ?></a></li>
              <li><a href="<?php echo $report_customer_summary; ?>"><?php echo $text_report_customer_summary; ?></a></li>
            </ul>
          </li>
          <li><a class="parent"><?php echo $text_product; ?></a>
            <ul>
              ...
              <li><a href="<?php echo $report_product_stocked; ?>"><?php echo $text_report_product_stocked; ?></a></li>
              <li><a href="<?php echo $report_category_missing; ?>"><?php echo $text_report_category_missing; ?></a></li>
              <li><a href="<?php echo $report_product_images; ?>"><?php echo $text_report_product_images; ?></a></li>
              <li><a href="<?php echo $report_manufacturer_missing; ?>"><?php echo $text_report_manufacturer_missing; ?></a></li>
            </ul>
          </li>
          <li><a class="parent"><?php echo $text_customer; ?></a>
            <ul>
    ...
    <ul class="right">
     <li><a onClick="window.open('https://console.mygateglobal.com/');" class="top">mygate</a></li>
     <li><a onClick="window.open('http://webmail5.konsoleh.co.za/');" class="top">Webmail</a></li>
