    ...
    <div class="content">
      <div class="overview">
        ...
        <div class="dashboard-content">
          <table>
            <tr>
              <td><?php echo $text_total_stock; ?></td>
            ...
            <tr>
                <td><?php echo $text_total_customer_month; ?></td>
                <td><?php echo $total_customer_month; ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><?php echo $text_total_returns; ?></td>
      ...
      <div class="statistic">
        ...
        <div class="dashboard-content">
          ...
          <div id="report" style="width: 390px; height: 190px; margin: auto;"></div>
        </div>
      </div>
      <div class="latest">
          ...
          <table class="list">
            <thead>
              <tr>
                ...
                <td class="left"><?php echo $column_shipping_method; ?></td>
...
var legend = document.getElementById("containerlegend");
	$.ajax({
		type: 'get',
		...
		success: function(json) {
			var option = {	
				...
				yaxes: [
                    { position: 'left', min: 0 },
                    { position: 'right', min:0 }, { alignTicksWithAxis: false }
				],
				legend: { show:true, noColumns:3, container:legend }
			}

			$.plot($('#report'), [json.order, json.customer, json.total], option);
		}
	});
}
