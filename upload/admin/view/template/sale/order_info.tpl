...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/order.png" alt="" /> <?php echo $heading_title; ?> - <?php echo $firstname; ?> <?php echo $lastname; ?></h1>
        <div class="buttons">
        <?php if ($edit) { ?>
            <a onclick="window.open('<?php echo $edit; ?>');" class="button">Edit</a>
        <?php } ?>
        <?php if ($login) { ?>
            <a onclick="window.open('<?php echo $login; ?>');" class="button">Login</a>
        <?php } ?>
            <a onclick="window.open('<?php echo $delivery_box; ?>');" class="button"><?php echo $button_delivery_box; ?></a>
            <a onclick="window.open('<?php echo $delivery; ?>');" class="button"><?php echo $button_delivery; ?></a>
