...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/customer.png" alt="" /> <?php echo $heading_title . $heading_title_name; ?></h1>
      <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <div id="htabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a>
        <?php if ($customer_id) { ?>
        <a href="#tab-transaction"><?php echo $tab_transaction; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-product"><?php echo $tab_product; ?></a>
        <?php } ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <div id="vtabs" class="vtabs"><a href="#tab-customer"><?php echo $tab_general; ?></a>
            ...
            <?php $address_row++; ?>
            <?php } ?>
              <span id="address-add"><?php echo $button_add_address; ?>&nbsp;<img src="view/image/add.png" alt="" onclick="addAddress();" /></span>
              <a href="#tab-cart" id="cart"><?php echo $tab_cart; ?></a>
               <a href="#tab-wishlist" id="wishlist"><?php echo $tab_wishlist; ?></a>
          </div>
          ...
          <?php $address_row++; ?>
            <?php } ?>
            <div id="tab-cart" class="vtabs-content" >
                <table class="list">
            <thead>
              <tr>
                <td class="left">
                ...
                <td class="left">
                  <?php echo $column_product_model; ?>
                </td>
                <td class="right">
                  <?php echo $column_product_quantity; ?>
                </td>
              </tr>
            </thead>
            <tbody>
            ...
            <div id="tab-wishlist" class="vtabs-content" >
                <table class="list">
            <thead>
              <tr>
                <td class="left">
