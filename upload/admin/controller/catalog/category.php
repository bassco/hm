...
class ControllerCatalogCategory extends Controller { 
	...
	public function update() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_category->editCategory((int)$this->request->get['category_id'], $this->request->post);
	...
	private function getForm() {
        ...
        $this->data['heading_title_name'] = " - ". $this->data['category_description'][$this->config->get('config_language_id')]['name'];
        if($this->data['heading_title_name'] == " - "){$this->data['heading_title_name'] = "";}
        ...
        $this->data['column_product_image']     = $this->language->get('column_product_image');
