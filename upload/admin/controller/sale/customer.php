...
class ControllerSaleCustomer extends Controller { 
	...
	public function approve() {
  	...
  	private function getList() {
		...
		$this->data['column_product_total'] = $this->language->get('column_product_total');
  	...
  	private function getForm() {
        ...
        if (!empty($customer_info)) {
			$results = $this->model_sale_customer->getProductsByCustomerId($this->request->get['customer_id']);
        ...
        $this->data['product_total'] = $this->currency->format($product_total, $this->config->get('config_currency'));
        ...
        $this->data['heading_title_name'] = "";
            ...
            $this->data['heading_title_name'] = " - " . $this->data['firstname'] ." " . $this->data['lastname'];
        }
        ...
        if (!empty($customer_info)) {
			$results = $this->model_report_carts->getCustCart($this->request->get['customer_id']);
		    $this->load->model('catalog/product');
			foreach ($results as $product_id=>$quantity) {
        ...
        if (!empty($customer_info)) {
			$results = $this->model_report_wishlisted->getCustWishlist($this->request->get['customer_id']);
		    $this->load->model('catalog/product');
