...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_report_category_missing'] = $this->language->get('text_report_category_missing');
		$this->data['text_report_manufacturer_missing'] = $this->language->get('text_report_manufacturer_missing');
		...
		$this->data['text_report_sale_summary'] = $this->language->get('text_report_sale_summary');
		$this->data['text_report_customer_summary'] = $this->language->get('text_report_customer_summary');
		$this->data['text_report_product_viewed'] = $this->language->get('text_report_product_viewed');
        $this->data['text_report_product_stocked'] = $this->language->get('text_report_product_stocked');
        $this->data['text_report_product_images'] = $this->language->get('text_report_product_images');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['report_sale_summary'] = $this->url->link('report/sale_summary', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_customer_summary'] = $this->url->link('report/customer_summary', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_product_viewed'] = $this->url->link('report/product_viewed', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['report_product_stocked'] = $this->url->link('report/product_stocked', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['report_product_images'] = $this->url->link('report/product_images', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['report_product_purchased'] = $this->url->link('report/product_purchased', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_category_missing'] = $this->url->link('report/category_missing', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_manufacturer_missing'] = $this->url->link('report/manufacturer_missing', 'token=' . $this->session->data['token'], 'SSL');
