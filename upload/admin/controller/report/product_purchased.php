...
class ControllerReportProductPurchased extends Controller {
    public function index() {
        ...
        $product_count = $this->model_report_product->getCountPurchased($data);
        ...
        $this->data['product_total'] = $this->language->get('product_total');
        $this->data['total'] = $this->currency->format($product_total, $this->config->get('config_currency'));
        ...
        $pagination->total = $product_count;
