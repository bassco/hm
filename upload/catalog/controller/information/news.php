...
class ControllerInformationNews extends Controller {
	...
	public function index() {
		...
		if ($news_info) {
			...
			$this->data['breadcrumbs'][] = array(
				'href'      => $this->url->link('information/news', 'news_id=' . (int)$this->request->get['news_id']),
			...
			$this->document->addLink($this->url->link('information/news', 'news_id=' . (int)$this->request->get['news_id']), 'canonical');
