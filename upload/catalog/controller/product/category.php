			...
			foreach ($results as $result) {
				...
				$this->data['categories'][] = array(
					...
					'href'  => $this->url->link('product/category', 'path=' . $this->request->get['path'] . '_' . $result['category_id'] . $url),
                                        'thumb' => ($result['image'] ? $this->model_tool_image->resize($result['image'], $this->config->get('config_image_category_width'), $this->config->get('config_image_category_height')) : (string)'bulk_image.jpg'),
                                        'description' => ($result['description'] ? html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8'): 'No description')
